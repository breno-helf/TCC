...
\begin{center}
    ...
    \vspace{3cm}
    \textbf{\Large{Hash Functions and Hash Tables}}
...
During the first part I explain why hash functions are an important idea in Computer Science, summarize some of the ideas Donald Knuth presented on his book (The Art of Computer programming, Vol. 3) and use some metrics to evaluate what is a good hash function.
